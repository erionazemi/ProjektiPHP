        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php if ($_SESSION['is_admin'] == 'true') { 
                ...
                <tr>
                    <td colspan="6" class="text-center">You must be an admin to view doctors</td>
                </tr>
            <?php } ?>
          </tbody>
        </table>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addMovieModalLabel">Add New Doctor</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="addMovie.php" method="post">
            <div class="mb-3">
              <label for="movie_name" class="form-label">Doctor Name</label>
              <input type="text" class="form-control" id="movie_name" name="movie_name" required>
            </div>
            <div class="mb-3">
              <label for="movie_desc" class="form-label">Doctor Description</label>
              <textarea class="form-control" id="movie_desc" name="movie_desc" rows="3" required></textarea>
            </div>
            <div class="mb-3">
              <label for="movie_quality" class="form-label">Doctor Field</label>
