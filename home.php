  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Health Clinic</h1>
        <p class="lead text-muted">At Health Clinic, your health and well-being are our top priorities. We are dedicated to providing compassionate, personalized care in a comfortable and welcoming environment. Whether you’re here for a routine check-up, specialized treatment, or health advice, our experienced team is here to support you every step of the way.
Thank you for trusting us with your care. We look forward to helping you achieve your best health.</p>
      </div>
    </div>
  </section>
