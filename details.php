  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Book your Appointment</h1>
        <p class="lead text-muted">You can book your Appoinment by clicking the button below</p>
      </div>
    </div>
  </section>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-6">
                    ...
                    <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit">Book Appointment</button>
                  </form>
                </div>
            </div>
        </div>
